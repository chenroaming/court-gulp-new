...
$(document).ready(function () {
    ...
    for (const item of notice.content){
        ...
        let div = ('<div class="content"><div><img src="../images/way-4.png" alt=""></div><a href="news.html?id='+item.unique_id+'" target="_blank">'+item.news_title+'</a><p>'+time.getFullYear()+'年'+(time.getMonth()+1)+'月'+time.getDate()+'日'+'</p></div>');
        $('#list').append(div);
    }
    $("#Pagination").paging({
      nowPage: 1, // 当前页码,默认为1
